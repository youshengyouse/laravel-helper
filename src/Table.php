<?php
// 参考 https://github.com/pgooch/PHP-Ascii-Tables
// 原本是为了debug_backtrace用 https://github.com/steevanb/php-backtrace/blob/master/DebugBacktraceConsole.php
// 效果如 https://github.com/steevanb/php-backtrace/blob/master/backtrace_console.jpg
